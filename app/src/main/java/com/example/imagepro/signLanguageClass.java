...
public class  signLanguageClass {
    ...
    signLanguageClass(ImageButton add_button, ImageButton clear_button, TextView tv_text, AssetManager assetManager, String modelPath, String labelPath, int inputSize, String classification_model, int classification_input_size) throws IOException{
...
//        options.addDelegate(gpuDelegate);
        ...
        add_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                full_text = full_text+current_letter;
                tv_text.setText(full_text);
            }
        });
    ...
    public Mat recognizeImage(Mat mat_image){
        ...
        for (int i=0;i<10;i++){
            ...
            if(score_value>0.5){
                ...
                //new convert this cropped mat to bitmap
                Bitmap bitmap1 = null;
                ...
                //convert scaledBitmap1 to bytebuffer
...
//                Imgproc.putText(rotated_mat_image,labelList.get((int) class_value),new Point(left,top),3,1,new Scalar(255, 0, 0, 255),2);
    ...
    //method to get alphabets from output_class_value
